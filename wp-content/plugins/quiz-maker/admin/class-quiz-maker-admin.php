...
class Quiz_Maker_Admin
{
    ...
    */
    ...
    public function ays_quiz_sale_baner(){
        if(isset($_POST['ays_quiz_sale_btn_spring'])){
            update_option('ays_quiz_sale_btn_spring', 1); 
            update_option('ays_quiz_sale_date', current_time( 'mysql' ));
        }

        if(isset($_POST['ays_quiz_sale_btn_spring_for_two_months'])){
            update_option('ays_quiz_sale_btn_spring_for_two_months', 1);
            update_option('ays_quiz_sale_date', current_time( 'mysql' ));
        }

        $ays_quiz_sale_date = get_option('ays_quiz_sale_date');
        $ays_quiz_sale_two_months = get_option('ays_quiz_sale_btn_spring_for_two_months');
        ...
        if(intval($days_diff) > 0 ){
            update_option('ays_quiz_sale_btn_spring', 0); 
            update_option('ays_quiz_sale_btn_spring_for_two_months', 0);
        }

        $ays_quiz_ishmar = intval(get_option('ays_quiz_sale_btn_spring'));
        $ays_quiz_ishmar += intval(get_option('ays_quiz_sale_btn_spring_for_two_months'));
        if($ays_quiz_ishmar == 0 ){
            if (isset($_GET['page']) && strpos($_GET['page'], AYS_QUIZ_NAME) !== false) {
                // $this->ays_quiz_sale_message($ays_quiz_ishmar);
                $this->ays_quiz_spring_bundle_message($ays_quiz_ishmar);
            }
        }
    }
