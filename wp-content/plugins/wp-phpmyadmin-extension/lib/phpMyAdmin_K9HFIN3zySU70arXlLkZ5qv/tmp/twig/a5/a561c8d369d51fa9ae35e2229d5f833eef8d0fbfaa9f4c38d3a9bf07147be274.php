...
class __TwigTemplate_dd54093e75d8bdc513ef88890d5b50140d27e56ff46615ce64954eb51f7ea025 extends Template
{
    private $source;
    private $macros = [];
          ...
          <tbody>
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["plugin"]) {
                ...
                echo "
                  ";
                // line 38
                if ((0 !== twig_compare(twig_get_attribute($this->env, $this->source, $context["plugin"], "status", [], "any", false, false, false, 38), "ACTIVE"))) {
                    // line 39
                    echo "                    <span class=\"badge bg-danger\">
                      ";
                    // line 40
                    if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["plugin"], "status", [], "any", false, false, false, 40), "INACTIVE"))) {
                        // line 41
                        echo "                        ";
echo _gettext("inactive");
                        // line 42
                        echo "                      ";
                    } elseif ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["plugin"], "status", [], "any", false, false, false, 42), "DISABLED"))) {
                        // line 43
                        echo "                        ";
echo _gettext("disabled");
                        // line 44
                        echo "                      ";
                    } elseif ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["plugin"], "status", [], "any", false, false, false, 44), "DELETING"))) {
                        // line 45
                        echo "                        ";
echo _gettext("deleting");
                        // line 46
                        echo "                      ";
                    } elseif ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["plugin"], "status", [], "any", false, false, false, 46), "DELETED"))) {
                        // line 47
                        echo "                        ";
...
";
    ...
    {
        return new Source("", "server/plugins/index.twig", "/bitnami/wordpress/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_K9HFIN3zySU70arXlLkZ5qv/templates/server/plugins/index.twig");
    }
}
