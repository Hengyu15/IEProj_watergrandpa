...
class __TwigTemplate_f545855f1741366eb1c611d6378b62b71933b7f81e5a550b91b547654e264cd4 extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Your preferences will be saved for current session only. Storing them permanently requires %sphpMyAdmin configuration storage%s.");
    ...
    {
        return new Source("", "preferences/header.twig", "/bitnami/wordpress/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_K9HFIN3zySU70arXlLkZ5qv/templates/preferences/header.twig");
    }
}
