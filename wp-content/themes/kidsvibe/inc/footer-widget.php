...
class KidsVibe_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'kidsvibe';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'kidsvibe' ), $i ),
...
// Initialize.
$kidsvibe_footer_widgets = new KidsVibe_Footer_Widgets();
