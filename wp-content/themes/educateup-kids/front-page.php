...
if ( is_front_page() && is_home() ) {
	...
	<main id="primary" class="site-main py-0">
		...
		$homepage_sections = array( 'banner', 'course', 'team', 'categories', 'counter', 'project', 'mission', 'testimonial', 'blog', 'newsletter' );
		foreach ( $homepage_sections as $value ) {
			if ( in_array( $value, array( 'categories', 'project', 'testimonial' ) ) ) {
