...
!(function (e, t) {
    ...
    var w = (e) => e && e.remove();
    const x = { "font-family": "", "font-weight": "", "font-size": "", "font-style": "", "line-height": "", color: "", "margin-left": "-.125em", "margin-right": ".125em" };
    function D(e, t, n) {
        if (!e.s) {
            if (n instanceof E) {
                        ...
                        try {
                            var r = (function () {
                                function e() {
                                    return (
                                        (_.completed = !0),
                                        Promise.resolve(ee.afterComplete(D)).then(function () {
                                            if (!ee.loop) throw "";
                                            let e = ee.loopDelay;
                                            E(function () {
                                                try {
                                ...
                                const n = C(t, function (e) {
                                    ...
                                    return (
                                        r.freezeCursor && V(!0),
                                        Promise.resolve(n[0].call(D, n[1], r)).then(function () {
                    ...
                    let r = g({ el: K, move: e, cursorPos: Z, to: t }),
                        o = () => {
                            ...
                            (e = r < 0 ? -1 : 1),
                                (t = Z),
                                (n = R()),
                                (Z = Math.min(Math.max(t + e, 0), n.length)),
                                ((e, t, n, r) => {
                                    let o = t[r - 1];
                        ...
                        E(function () {
                            try {
                                ...
                                const t = H(
                                    ...
                                    function () {
                                        return n ? void o() : Promise.resolve(E(o, z(0))).then(function (e) {});
                                    }
                                );
                        ...
                        E(function () {
                            try {
                                ...
                                const s = H(
                                    ...
                                    function () {
                                        return t ? void o() : Promise.resolve(E(o, z(1))).then(function (e) {});
                                    }
                                );
                                  ...
                                  re
                                      ? (((e, t, n) => {
                                            let r = "[data-typeit-id='" + e + "'] ." + m,
                                                ...
                                                i = Object.entries(x).reduce((e, [t, n]) => e + " " + t + ": var(--ti-" + t + ", " + (n || o[t]) + ");", "");
                                            a(
                                                "@keyframes blink-" +
                                                    e +
